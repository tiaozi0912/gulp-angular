(function() {
  ...
  mailer.sendEmailVerification = function(user, token) {
    ...
    content = '<p>Hi ' + this.name + ':</p><br>' + '<p> Welcome to Agora! Please verify your email by clicking the following link: </p>' + '<a href="' + url + '">' + url + '</a><br>' + '<p> Best regards, </p>' + '<p>Agora Team</p><br>' + '<br><p>(If you did not request an Agora account, please ignore this message.)</p>';
